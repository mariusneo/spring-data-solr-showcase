...
<body>
	...
	<div id="accordion">
		...
		<c:if test="${product.location != null}">
			...
			<div>
				<p>
					<img ismap="ismap" height="220" src="http://maps.googleapis
					.com/maps/api/staticmap?markers=color:green|${product.location.x},${product.location.y}&zoom=12&size=200x200&sensor=false" />
				</p>
			</div>
		</c:if>
	</div>	
